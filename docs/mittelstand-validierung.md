...
| Protokoll-Probe gegen Ollama `/v1` (dev-Suite, llama3.1, gleiche Seeds) | _wird nach Run C eingetragen_ |
...
| TTFT-Probe (GPU-PC, llama3.1, 5 Läufe, Seeds 1001–1005) | _wird nach TTFT-Lauf eingetragen_ |
...
| Live-Smoke gegen GPU-Ollama | _wird nach Live-Test eingetragen_ |
